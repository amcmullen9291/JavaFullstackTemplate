...
function headerCode(e){
  ...
  const mainSection = (
    <>
          ...
          <ul>
              <li id="mainSection">This is (almost) the exact same page As the introduction page. But, look how little code is in the the return statement! Hover over each element to see the code that created it. Note: the headers, H1-H6 are block level elements. That means the element will always take up an entire line even if it is not needed</li>
              <ol>
