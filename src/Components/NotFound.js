...
const NotFound = () => {
  ...
  return(
    ...
    <p>thanks to the Router that you imported from the 'react-router-dom' dependency, the program will not break..</p></center>
    <hr></hr>
    <br></br>
    <p id="four0fourExplination" class="four0four"> The router will just keep going to this annoying page if it is not sure where to go.</p>
    </div>
    </div>
    <footer>
